...
const questions = [
  ...
  { axis: 'RW', dir: -1, text: '自分の気持ちより推しの幸せや成功が大事。' },

  // EI
  { axis: 'EI', dir: +1, text: '推しの良さを誰かに伝えたり共有したい。' },
  { axis: 'EI', dir: +1, text: '推し活で仲間とつながることにワクワクする。' },
  { axis: 'EI', dir: -1, text: '推し活は基本ひとりでするほうが落ち着く。' },
  { axis: 'EI', dir: -1, text: '発信するより自分の中で深く楽しむ時間が大切。' },

  // DL
  { axis: 'DL', dir: +1, text: '生活のリズムに推し活が組み込まれている。' },
  { axis: 'DL', dir: +1, text: '推しを追いたい気持ちが継続的にある。' },
  { axis: 'DL', dir: -1, text: '忙しいときは推し活の優先度を下げられる。' },
  { axis: 'DL', dir: -1, text: '推し活は無理のない範囲で楽しみたい。' },

  // SV
  { axis: 'SV', dir: +1, text: '基本的にひとりの推しを長く推すほうだ。' },

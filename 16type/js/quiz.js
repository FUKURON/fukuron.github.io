...
const questions = [
  // RW
  { axis: 'RW', dir: +1, text: '推しの言葉や出来事を、自分のことのように受け止めて心が揺れる。' },
  { axis: 'RW', dir: +1, text: '推しとの「もしも」の物語や、関係性を想像してしまうことがある。' },
  { axis: 'RW', dir: -1, text: '推しは推し、私は私。感情的に入り込みすぎない距離が心地いい。' },
  { axis: 'RW', dir: -1, text: '自分の気持ちよりも、推しが幸せで成功してくれることがいちばん大事だ。' },

  // EI
  { axis: 'EI', dir: +1, text: '推しの感想や考察は、誰かに伝えたり投稿したりして共有したくなる。' },
  { axis: 'EI', dir: +1, text: '現場やオンラインで、同担・仲間とつながることにワクワクする。' },
  { axis: 'EI', dir: -1, text: '推し活は基本ひとりで完結するほうが落ち着く。' },
  { axis: 'EI', dir: -1, text: '発信よりも、自分の中で噛みしめて深く楽しむ時間が大切だ。' },

  // DL
  { axis: 'DL', dir: +1, text: '推し活の予定（現場・配信・記念日など）が、生活のリズムに組み込まれている。' },
  { axis: 'DL', dir: +1, text: 'グッズや作品を「揃えたい」「追いたい」という気持ちが継続的にある。' },
  { axis: 'DL', dir: -1, text: '推し活は息抜き。忙しいときはスパッと優先度を下げられる。' },
  { axis: 'DL', dir: -1, text: '現場は"行けたら行く"くらいで、無理のない範囲で楽しみたい。' },

  // SV
  { axis: 'SV', dir: +1, text: 'ひとり（または少数）の推しを、長く深く追いかけるほうがしっくりくる。' },
  { axis: 'SV', dir: +1, text: '推しの解釈や世界観を、時間をかけて育てていくのが好きだ。' },
  { axis: 'SV', dir: -1, text: '気になるものは複数同時に推せるし、ジャンル移動にも抵抗がない。' },
  { axis: 'SV', dir: -1, text: '"いま刺さる熱"を大事にして、幅広くいろんな推し方を楽しみたい。' }
];
